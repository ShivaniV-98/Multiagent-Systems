...
class GridWorld:
    ...
    def agent2_on_map(self):
        ...
        #grid[self.agent2_location[0], self.agent2_location[1]] = 2
        return grid
    def get_reward(self, agent1_location,agent2_location):
        """Returns the reward for an input position"""
        return self.grid[agent1_location[0], agent1_location[1]]+ self.grid[agent2_location[0], agent2_location[1]]
    ...
    def agent1_make_step(self, action):
        ...
        if action == 'UP':
            ...
            if last_location_1[0] == 0:
                ...
                reward = self.get_reward(last_location_1,last_location_2)
            else:
                ...
                reward = self.get_reward(self.agent1_location,self.agent2_location)
    ...
    def agent2_make_step(self, action):
        ...
        if action == 'UP':
            ...
            if last_location_2[0] == 0:
                ...
                #self.agent2_location = (self.agent2_location[0] - 1, self.agent2_location[1])
                reward = self.get_reward(self.agent2_location, self.agent1_location)
...
class Play_game:
    ...
    def play(self,environment,agent1,agent2, trials=10,max_steps_per_episode=10000):
